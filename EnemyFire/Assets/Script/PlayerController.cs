...
public class PlayerController : MonoBehaviour
{
    ...
    Camera cam;
    [SerializeField]
    Vector2 touchPos = Vector2.zero, targetPos = Vector2.zero, firePos = Vector2.zero;
    [SerializeField]
    ...
    public void DoAction(Vector2 Slidepos, Vector2 fireTouch, int horizTouch = 0, int vertTouch = 0)
    {
        touchPos = Slidepos;
        firePos = fireTouch;
        ...
        if (horizTouch == 2)
        {
            particlePos = cam.ScreenToWorldPoint(fireTouch);
